...
USERINCLUDE    := \
		...
		-I$(srctree)/drivers/soc/jlq/audio-kernel/include/uapi \
...
LINUXINCLUDE    := \
		...
		-I$(srctree)/drivers/soc/jlq/audio-kernel/include \
...
dtbs_install:
	...
	find ${dtstree} -name "*.dtb" | xargs cat > ${dtstree}/jlq_jr510.dtb
