...
/**
 * struct cam_soc_flash_pinctrl_info:   Information about pinctrl data
 *
 * @pinctrl:                pintrl object
 * @gpio_state_flash_high:  flash high pinctrl state
 * @gpio_state_flash_low:   flash low pinctrl state
 * @gpio_state_flash_off:   flash off pinctrl state
 **/
struct cam_soc_flash_pinctrl_info {
	struct pinctrl *pinctrl;
	struct pinctrl_state *gpio_state_flash_high;
	struct pinctrl_state *gpio_state_flash_low;
