...
EXPORT_SYMBOL_GPL(TEEC_InitializeContext);
...
EXPORT_SYMBOL_GPL(TEEC_FinalizeContext);
...
EXPORT_SYMBOL_GPL(TEEC_OpenSession);
...
EXPORT_SYMBOL_GPL(TEEC_CloseSession);
...
EXPORT_SYMBOL_GPL(TEEC_InvokeCommand);
...
EXPORT_SYMBOL_GPL(TEEC_RequestCancellation);
...
EXPORT_SYMBOL_GPL(TEEC_RegisterSharedMemory);
...
EXPORT_SYMBOL_GPL(TEEC_RegisterSharedMemoryFileDescriptor);
...
EXPORT_SYMBOL_GPL(TEEC_AllocateSharedMemory);
...
EXPORT_SYMBOL_GPL(TEEC_ReleaseSharedMemory);
