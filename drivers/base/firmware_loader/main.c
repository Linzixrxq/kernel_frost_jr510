...
static const char * const fw_path[] = {
	...
	"/lib/firmware"
	"/vendor/dsp_firmware/" UTS_RELEASE,
	"/vendor/dsp_firmware"
	"/vendor/dsp_firmware/image/" UTS_RELEASE,
	"/vendor/dsp_firmware/image",
	"/vendor/etc/adsp_calibration/" UTS_RELEASE,
	"/vendor/etc/adsp_calibration",
};
