...
//#include "ufshcd-crypto-qti.h"	//TO_DO:
...
static int ufs_qcom_init(struct ufs_hba *hba)
{
	 ...
	 */
	//ufshcd_crypto_qti_set_vops(hba);	//TO_DO:
#ifdef CONFIG_SCSI_UFS_CRYPTO_JLQ
	ufshcd_crypto_jlq_set_vops(hba);
#endif
...
static int ufs_qcom_probe(struct platform_device *pdev)
{
	...
	dev_dbg(dev, "ufs_qcom_probe: android_boot_dev %s dev_name(dev) %s non-removable %d\n",
		android_boot_dev, dev_name(dev),
