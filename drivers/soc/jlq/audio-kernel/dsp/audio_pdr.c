...
#include <soc/jlq/service-locator.h>
#include <soc/jlq/service-notifier.h>
#include "audio_pdr.h"
...
subsys_initcall(audio_pdr_late_init);
...
MODULE_SOFTDEP("pre: jlq_clk jlq-regulator jlq-gpio spmi-pmic-arb jlq-slimbus");
