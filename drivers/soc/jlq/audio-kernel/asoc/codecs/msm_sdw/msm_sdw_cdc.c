...
static int __init msm_sdw_codec_init(void)
{
    int r = platform_driver_register(&msm_sdw_codec_driver);
...
static void __exit msm_sdw_codec_exit(void)
{
   platform_driver_unregister(&msm_sdw_codec_driver);
}

module_init(msm_sdw_codec_init);
module_exit(msm_sdw_codec_exit);
