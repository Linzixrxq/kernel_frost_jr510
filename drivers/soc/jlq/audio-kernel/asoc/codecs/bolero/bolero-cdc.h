...
#define HAPS_TEST
#define BOLERO_REGU
#define BOLERO_SUPPORT_VAD

#ifdef HAPS_TEST
//#define DMAS_TEST

#define BOLERO_IF_FIFO_CLK_EN_OFFSET            0x40
#define BOLERO_IF_FIFO_RESET_EN_OFFSET          0x44

#define DMAS0_EN_OFFSET         (0)
#define DMAS0_CLR_OFFSET        (4)
#define DMAS0_STA_OFFSET        (8)
#define DMAS0_CH0_SAR_OFFSET    (0x40)
#define DMAS0_CH0_DAR_OFFSET	(0x44)
#define DMAS0_CH0_CTL0_OFFSET	(0x48)
#define DMAS0_CH0_CTL0_OFFSET	(0x48)
#define DMAS0_CH0_CTL1_OFFSET	(0x4C)
#define DMAS0_CH0_CA_OFFSET     (0x50)

#ifdef DMAS_TEST
extern char __iomem *audsys_base;
extern char __iomem *dmas_base;
extern char __iomem *dmas_src;
#endif
...
static inline int bolero_resume(struct device *dev)
{
	return 0;
}

static int bolero_suspend(struct device *dev)
{
	return 0;
}
