...
u8 bolero_va_reg_access[BOLERO_CDC_VA_MACRO_MAX] = {
	...
	[BOLERO_REG(BOLERO_CDC_VA_VAD_FILTER_CFG)] = RD_WR_REG,
	[BOLERO_REG(BOLERO_CDC_VA_VAD_IRQ_MSK)] = RD_WR_REG,
	[BOLERO_REG(BOLERO_CDC_VA_VAD_CH0_SNR_THR_L)] = RD_WR_REG,
	[BOLERO_REG(BOLERO_CDC_VA_VAD_CH0_N_FRM)] = RD_WR_REG,
	[BOLERO_REG(BOLERO_CDC_VA_VAD_INTR1_MSK_EN)] = RD_WR_REG,
	[BOLERO_REG(BOLERO_CDC_VA_VAD_INTR2_MSK_EN)] = RD_WR_REG,
#endif
};
