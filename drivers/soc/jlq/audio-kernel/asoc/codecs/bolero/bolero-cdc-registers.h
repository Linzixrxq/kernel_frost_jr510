...
#define BOLERO_CDC_VA_VAD_FILTER_CFG        ((VA_START_OFFSET + 0x0184))
#define BOLERO_CDC_VA_VAD_IRQ_MSK           ((VA_START_OFFSET + 0x018C))
#define BOLERO_CDC_VA_VAD_CH0_SNR_THR_L     ((VA_START_OFFSET + 0x01B0))
#define BOLERO_CDC_VA_VAD_CH0_N_FRM         ((VA_START_OFFSET + 0x01B8))
#define BOLERO_CDC_VA_VAD_INTR1_MSK_EN      ((VA_START_OFFSET + 0x0360))
#define BOLERO_CDC_VA_VAD_INTR2_MSK_EN      ((VA_START_OFFSET + 0x0380))
#endif
