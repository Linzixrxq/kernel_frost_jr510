...
ifeq ($(call is-board-platform-in-list,msmnile $(MSMSTEPPE) $(TRINKET) kona lito jr510 sdmshrike sdm660),true)
...
###########################################################
ifneq ($(call is-board-platform-in-list, jr510),true)
include $(CLEAR_VARS)
...
###########################################################
ifeq ($(call is-board-platform-in-list, jr510),true)
include $(CLEAR_VARS)
