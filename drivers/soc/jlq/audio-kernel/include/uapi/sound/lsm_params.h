...
#define SNDRV_LSM_SET_MODULE_PARAMS_V2 _IOW('U', 0x13, \
					struct snd_lsm_module_params)
#define SNDRV_LSM_ASR_START	_IO('U', 0x14)
#define SNDRV_LSM_ASR_STOP	_IO('U', 0x15)
#define SNDRV_LSM_READ_KWS_DATA	_IOR('U', 0x16, struct snd_kws_data)
