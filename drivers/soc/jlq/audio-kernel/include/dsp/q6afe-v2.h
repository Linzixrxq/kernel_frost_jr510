...
__inline static int afe_loopback(u16 enable, u16 rx_port, u16 tx_port){return 0;};
__inline static int afe_sidetone_enable(u16 tx_port_id, u16 rx_port_id, bool enable){return 0;};
__inline static int afe_set_display_stream(u16 rx_port_id, u32 stream_idx, u32 ctl_idx){return 0;};
__inline static int afe_loopback_gain(u16 port_id, u16 volume){return 0;};
__inline static int afe_get_topology(int port_id){return 0;};
__inline static uint32_t afe_req_mmap_handle(struct afe_audio_client *ac){return 0;};
__inline static int afe_memory_map(phys_addr_t dma_addr_p, u32 dma_buf_sz,
		struct afe_audio_client *ac){return 0;};
__inline static int afe_cmd_memory_map(phys_addr_t dma_addr_p, u32 dma_buf_sz){return 0;};
__inline static int afe_cmd_memory_map_nowait(int port_id, phys_addr_t dma_addr_p,
			u32 dma_buf_sz){return 0;};
__inline static int afe_cmd_memory_unmap(u32 dma_addr_p){return 0;};
__inline static int afe_cmd_memory_unmap_nowait(u32 dma_addr_p){return 0;};

__inline static void afe_set_dtmf_gen_rx_portid(u16 rx_port_id, int set){return;};
__inline static int afe_dtmf_generate_rx(int64_t duration_in_ms,
			 uint16_t high_freq,
			 uint16_t low_freq, uint16_t gain){return 0;};
__inline static int afe_register_get_events(u16 port_id,
		void (*cb)(uint32_t opcode,
		uint32_t token, uint32_t *payload, void *priv),
		void *private_data){return 0;};
__inline static int afe_unregister_get_events(u16 port_id){return 0;};
__inline static int afe_rt_proxy_port_write(phys_addr_t buf_addr_p,
			u32 mem_map_handle, int bytes){return 0;};
__inline static int afe_rt_proxy_port_read(phys_addr_t buf_addr_p,
			u32 mem_map_handle, int bytes){return 0;};
__inline static void afe_set_cal_mode(u16 port_id, enum afe_cal_mode afe_cal_mode){return;};
__inline static void afe_set_vad_cfg(u32 vad_enable, u32 preroll_config,
		     u32 port_id){return;};
__inline static void afe_set_island_mode_cfg(u16 port_id, u32 enable_flag){return;};
__inline static void afe_get_island_mode_cfg(u16 port_id, u32 *enable_flag){*enable_flag=0;};
__inline static int afe_set_tws_channel_mode(u32 foramt, u16 port_id, u32 channel_mode){return 0;};
__inline static int afe_spk_prot_feed_back_cfg(int src_port, int dst_port,
	int l_ch, int r_ch, u32 enable){return 0;};
__inline static int afe_spk_prot_get_calib_data(struct afe_spkr_prot_get_vi_calib *calib){return 0;};
__inline static int afe_apply_gain(u16 port_id, u16 gain){return 0;};
__inline static int afe_pseudo_port_start_nowait(u16 port_id){return 0;};
__inline static int afe_pseudo_port_stop_nowait(u16 port_id){return 0;};
__inline static int afe_set_lpass_clock(u16 port_id, struct afe_clk_cfg *cfg){return 0;};
__inline static int afe_set_lpass_clock_v2(u16 port_id, struct afe_clk_set *cfg){return 0;};
__inline static int afe_set_lpass_clk_cfg(int index, struct afe_clk_set *cfg){return 0;};
__inline static int afe_set_digital_codec_core_clock(u16 port_id,
			struct afe_digital_clk_cfg *cfg){return 0;};
__inline static int afe_set_lpass_internal_digital_codec_clock(u16 port_id,
				struct afe_digital_clk_cfg *cfg){return 0;};
__inline static int afe_enable_lpass_core_shared_clock(u16 port_id, u32 enable){return 0;};

__inline static int q6afe_check_osr_clk_freq(u32 freq){return 0;};

__inline static int afe_send_spdif_clk_cfg(struct afe_param_id_spdif_clk_cfg *cfg,
		u16 port_id){return 0;};
__inline static int afe_send_spdif_ch_status_cfg(struct afe_param_id_spdif_ch_status_cfg
		*ch_status_cfg,	u16 port_id){return 0;};

__inline static int afe_spdif_port_start(u16 port_id, struct afe_spdif_port_config *spdif_port,
		u32 rate){return 0;};

__inline static int afe_spdif_reg_event_cfg(u16 port_id, u16 reg_flag,
		void (*cb)(uint32_t opcode,
		uint32_t token, uint32_t *payload, void *priv),
		void *private_data){return 0;};

__inline static int afe_turn_onoff_hw_mad(u16 mad_type, u16 mad_enable){return 0;};
__inline static int afe_port_set_mad_type(u16 port_id, enum afe_mad_type mad_type){return 0;};
__inline static enum afe_mad_type afe_port_get_mad_type(u16 port_id){return 0;};
__inline static void afe_set_aanc_info(struct aanc_data *aanc_info){return;};
__inline static int afe_set_aanc_noise_level(int val){return 0;};
__inline static int afe_port_group_set_param(u16 group_id,
	union afe_port_group_config *afe_group_config){return 0;};
__inline static int afe_port_group_enable(u16 group_id,
	union afe_port_group_config *afe_group_config, u16 enable,
	struct afe_param_id_tdm_lane_cfg *lane_cfg){return 0;};
__inline static int afe_unmap_rtac_block(uint32_t *mem_map_handle){return 0;};
__inline static int afe_map_rtac_block(struct rtac_cal_block_data *cal_block){return 0;};
__inline static int afe_send_slot_mapping_cfg(
	struct afe_param_id_slot_mapping_cfg *slot_mapping_cfg,
	u16 port_id){return 0;};
__inline static int afe_send_custom_tdm_header_cfg(
	struct afe_param_id_custom_tdm_header_cfg *custom_tdm_header_cfg,
	u16 port_id){return 0;};
__inline static int afe_tdm_port_start(u16 port_id, struct afe_tdm_port_config *tdm_port,
		       u32 rate, u16 num_groups){return 0;};
__inline static int afe_get_av_dev_drift(struct afe_param_id_dev_timing_stats *timing_stats,
		u16 port){return 0;};
__inline static int afe_get_sp_rx_tmax_xmax_logging_data(
		struct afe_sp_rx_tmax_xmax_logging_param *xt_logging,
		u16 port_id){return 0;};
__inline static int afe_cal_init_hwdep(void *card){return 0;};
__inline static int afe_send_port_island_mode(u16 port_id){return 0;};
__inline static int afe_send_port_vad_cfg_params(u16 port_id){return 0;};
__inline static int afe_send_cmd_wakeup_register(void *handle, bool enable){return 0;};
__inline static void afe_register_wakeup_irq_callback(
	void (*afe_cb_wakeup_irq)(void *handle)){return;};
__inline static int afe_get_doa_tracking_mon(u16 port_id,
	struct doa_tracking_mon_param *doa_tracking_data){return 0;};
...
__inline static int afe_vote_lpass_core_hw(uint32_t hw_block_id, char *client_name,
			uint32_t *client_handle){return 0;};
__inline static int afe_unvote_lpass_core_hw(uint32_t hw_block_id, uint32_t client_handle){return 0;};
__inline static int afe_get_spk_initial_cal(void){return 0;};
__inline static void afe_get_spk_r0(int *spk_r0){return;};
__inline static void afe_get_spk_t0(int *spk_t0){return;};
__inline static int afe_get_spk_v_vali_flag(void){return 0;};
__inline static void afe_get_spk_v_vali_sts(int *spk_v_vali_sts){return;};
__inline static void afe_set_spk_initial_cal(int initial_cal){return;};
__inline static void afe_set_spk_v_vali_flag(int v_vali_flag){return;};
