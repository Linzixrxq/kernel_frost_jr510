...
#endif
# if 0 //90 
  	for (row = 0; row < rx_num; row++) {
		for (col = 0; col < tx_num; col++) {
			seq_printf(file, "%6d", rawdata[rx_num * col + (rx_num - 1 - row)]);
		}
		seq_printf(file, "\n");
	}
#endif
	...
	for (row = 0; row < tx_num; row++) {
		for (col = 0; col < rx_num; col++) {
			seq_printf(file, "%6d", rawdata[rx_num * (tx_num - 1- row) + col]);
		}
		seq_printf(file, "\n");
	}
#endif
	...
	for (row = 0; row < rx_num; row++) {
		for (col = 0; col < tx_num; col++) {
			seq_printf(file, "%6d", rawdata[rx_num * (tx_num - 1 - col) + row]);
		}
		seq_printf(file, "\n");
	}
#endif
...
# if 0 //90 
  	for (row = 0; row < rx_num; row++) {
		for (col = 0; col < tx_num; col++) {
			seq_printf(file, "%6d", diffdata[rx_num * col + (rx_num - 1 - row)]);
		}
		seq_printf(file, "\n");
	}
#endif
	...
	for (row = 0; row < tx_num; row++) {
		for (col = 0; col < rx_num; col++) {
			seq_printf(file, "%6d", diffdata[rx_num * (tx_num - 1- row) + col]);
		}
		seq_printf(file, "\n");
	}
#endif
	...
	for (row = 0; row < rx_num; row++) {
		for (col = 0; col < tx_num; col++) {
			seq_printf(file, "%6d", diffdata[rx_num * (tx_num - 1 - col) + row]);
		}
		seq_printf(file, "\n");
	}
#endif
