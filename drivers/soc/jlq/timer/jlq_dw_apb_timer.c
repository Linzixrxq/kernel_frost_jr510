		       ...
		       void __iomem *base, int irq, unsigned long freq)
{
	...
	dw_ced->ced.max_delta_ns = clockevent_delta2ns(0x7fffffff,
						       &dw_ced->ced);
#else
	dw_ced->ced.max_delta_ns = 0x1a0aaaaae8;
#endif
...
#else
	dw_ced->ced.min_delta_ns = 0x3f940;
#endif
...
void dw_apb_clockevent_register(struct dw_apb_clock_event_device *dw_ced)
{
	...
	clockevents_config_and_register(&dw_ced->ced, dw_ced->timer.freq,
					dw_ced->ced.min_delta_ns,
					dw_ced->ced.max_delta_ns);
	apbt_enable_int(&dw_ced->timer);
}
