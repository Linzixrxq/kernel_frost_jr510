...
#define ENABLE_CHGBLOCK             1
#undef ENABLE_TERMBLOCK
#define ENABLE_TERMBLOCK            1
...
#endif
#define GAUGE_LOG_MIN_TIMESPAN      20
...
#define CMD_FILFCC                  0x0E /* 20211207, Ethan */
#define CMD_OCV                     0x64
#define CMD_DESIGNCAP               0x3C
...
#define BUF2U32_BG(p)               ((u32)(((u32)(u8)((p)[0]) << 24) \
		| ((u32)(u8)((p)[1]) << 16) | ((u32)(u8)((p)[2]) << 8) | (u8)((p)[3])))
#define BUF2U32_LT(p)               ((u32)(((u32)(u8)((p)[3]) << 24) \
		| ((u32)(u8)((p)[2]) << 16) | ((u32)(u8)((p)[1]) << 8) | (u8)((p)[0])))
...
#define CMD_SECTOR_FLAG             (CMDMASK_ALTMAC_R | 0x00C7) /* 20220315, Ethan */
#define MASK_SECTOR_FLAG            0x0FFF /* 20220315, Ethan */
...
#define CHECK_VERSION_AFI_DEBUG     BIT(3)
