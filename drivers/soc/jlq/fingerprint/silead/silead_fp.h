...
#if !defined(BSP_SIL_PLAT_JLQ)
  #define BSP_SIL_PLAT_COMM
#endif /* ! BSP_SIL_PLAT_JLQ */
...
#if defined(BSP_SIL_POWER_SUPPLY_REGULATOR) && defined(BSP_SIL_POWER_SUPPLY_PINCTRL) \
    || defined(BSP_SIL_POWER_SUPPLY_REGULATOR) && defined(BSP_SIL_POWER_SUPPLY_GPIO) \
    || defined(BSP_SIL_POWER_SUPPLY_GPIO) && defined(BSP_SIL_POWER_SUPPLY_PINCTRL)
  #error "Don't define multiple power supply mode!"
#endif

#ifdef BSP_SIL_PLAT_JLQ
  #define JTEE_V1  /* Enable it if JTEE v1 or higher */
  #include "silead_fp_jlq.h"
  #define PLAT_H "silead_fp_jlq.c"
