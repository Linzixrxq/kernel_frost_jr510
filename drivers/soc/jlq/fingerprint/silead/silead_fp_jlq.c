/*
 * @file   silead_fp_jlq.c
 * @brief  Contains silead_fp device implements for JLQ platform.
 *
 *
...
#ifndef __SILEAD_FP_JLQ__
#define __SILEAD_FP_JLQ__

#include <linux/of_irq.h>
#ifdef CONFIG_MICROTRUST_TEE_SUPPORT
#include "teei_fp.h"
#include "tee_client_api.h"
const struct TEEC_UUID uuid_silead = { 0x511EAD0A, 0x0000, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
#endif
...
#ifdef CONFIG_MICROTRUST_TEE_SUPPORT
		memcpy(&uuid_fp, &uuid_silead, sizeof(struct TEEC_UUID));
#endif
...
#endif /* __SILEAD_FP_JLQ__ */

#endif /* BSP_SIL_PLAT_JLQ */

/* End of file spilead_fp_jlq.c */
