...
int gf_parse_dts(struct gf_dev *gf_dev)
{
	...
	/*get pwr resource */
	gf_dev->pwr_gpio =
	    of_get_named_gpio(gf_dev->spi->dev.of_node, "vdd_gpios", 0);
	...
	/*get reset resource */
	gf_dev->reset_gpio =
	    of_get_named_gpio(gf_dev->spi->dev.of_node, "rst-gpios", 0);
	...
	/*get irq resourece */
	gf_dev->irq_gpio =
	    of_get_named_gpio(gf_dev->spi->dev.of_node, "irq-gpios", 0);
