...
static enum drm_mode_status drm_virtcon_mode_valid(struct drm_connector *connector,
...
static enum drm_mode_status drm_vencoder_mode_valid(struct drm_encoder *encoder,
				  const struct drm_display_mode *mode)
{
