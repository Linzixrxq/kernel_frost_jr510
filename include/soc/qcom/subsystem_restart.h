...
#define RMB_MBA_IMAGE			0x00 //QTANG_MSG_BUFFER0
#define RMB_PBL_STATUS			0x04 //QTANG_MSG_BUFFER1
#define RMB_MBA_COMMAND			0x08 //QTANG_MSG_BUFFER2
#define RMB_MBA_STATUS			0x0C //QTANG_MSG_BUFFER3
#define RMB_PMI_META_DATA		0x10 //QTANG_MSG_BUFFER4
#define RMB_PMI_CODE_START		0x14 //QTANG_MSG_BUFFER5
#define RMB_PMI_CODE_LENGTH		0x18 //QTANG_MSG_BUFFER6
#define RMB_PROTOCOL_VERSION		0x1C //QTANG_MSG_BUFFER7
#define RMB_MBA_DEBUG_INFORMATION	0x20 //QTANG_MSG_BUFFER8
#define RMB_SOC_FIRST_BOOT			0x24 //QTANG_MSG_BUFFER9
#define RMB_QTANG_FIRST_BOOT		0x28 //QTANG_MSG_BUFFER10


// PM refers to RPM image
#define RMB_PM_IMAGE_START		0x30 //QTANG_MSG_BUFFER12
#define RMB_PM_CODE_START		0x34 //QTANG_MSG_BUFFER13
#define RMB_PM_CODE_LENGTH		0x38 //QTANG_MSG_BUFFER14
#define RMB_PM_RESET_STATUS		0x3C //QTANG_MSG_BUFFER15
#define RMB_PM_DEBUG_INFORMATION	0x40 //QTANG_MSG_BUFFER16

// refers to DP image
#define RMB_DP_IMAGE_START		0x4C //QTANG_MSG_BUFFER19
#define RMB_DP_CODE_START		0x50 //QTANG_MSG_BUFFER20
#define RMB_DP_CODE_LENGTH		0x54 //QTANG_MSG_BUFFER21
#define RMB_SSR_DUMP_FLAG		0x58 //QTANG_MSG_BUFFER22

#define MODEM_SSR_DUMP_MASK		0x02 //modem ssr dump flag mask
#define MODEM_SSR_MASK			0x04 //modem restart flag mask


#define  QTANG_BOOT_REQUEST 0x30088
#define  QTANG_BOOT_STATUS	0x300AC
...
#define STATUS_AUTH_COMPLETE		0x3F
#define STATUS_MBA_UNLOCKED		0x6
#define STATUS_QTANG_PM_READY	0x1F

#define CMD_META_DATA_READY		0x3
#define CMD_RPM_LOAD_READY		0x02
#define CMD_MSADP_LOAD_READY	0x01
#define CMD_QBL_UNLOCK_DDR		0x4
...
#define TOP_DDR_SYSCTRL_BASE	0x34686000
#define QTANG_LOCK_REGISTER		0xE8
...
struct subsys_desc {
	...
	int (*npa_vote)(const struct subsys_desc *desc);
	int (*qtang_cxmx_vote)(const struct subsys_desc *desc);
	int (*load_qbl)(const struct subsys_desc *desc);
	int (*load_msadp)(const struct subsys_desc *desc);
	void (*disable_irqs)(const struct subsys_desc *desc);
